...
//        
//      }
//            else if (SM == LOW && SR == HIGH && SL == HIGH)
//      {
//            forward();
//      }
...
//      }
//      else if (SM == HIGH && SR == LOW && SL == HIGH)
//      {
//            goLeft(40,160);delay(100);
//    
//      }
//      else if(SM == LOW && SR == LOW && SL == HIGH)
//      {
//            goLeft(200,80);delay(100);
//      }
//      else if(SM == LOW && SR == HIGH && SL == LOW)
//      {
...
{
  motor1.setSpeed(b-100); 
  motor1.run(FORWARD); 
  motor2.setSpeed(a-100); 
  motor2.run(FORWARD); 
}
